...
import com.example.chatapp.manager.UserStatusManager
...
class MainActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Adicionar observer do ciclo de vida da aplicação
        ProcessLifecycleOwner.get().lifecycle.addObserver(userStatusManager)
